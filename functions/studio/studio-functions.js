...
let stringResult = reverseCharacters(myVariableName);
let numberResult = reverseCharacters(12345);
...
function reversedArr(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        let unreversedArr = reverseCharacters(arr[i]);
        emptyArr.push(unreversedArr);
    }
    return emptyArr.reverse();
}
console.log(reversedArr(arrayTest1));
console.log(reversedArr(arrayTest2));
console.log(reversedArr(arrayTest3));
// Bonus Missions
